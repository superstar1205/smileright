...
@Component({
  selector: 'app-philips-zoom-in-office',
  templateUrl: './philips-zoom-in-office.component.html',
  styleUrls: ['./philips-zoom-in-office.component.css']
})
export class PhilipsZoomInOfficeComponent implements OnInit {
