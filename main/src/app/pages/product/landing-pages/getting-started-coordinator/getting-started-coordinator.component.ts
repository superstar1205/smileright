...
@Component({
  selector: 'app-getting-started-coordinator',
  templateUrl: './getting-started-coordinator.component.html',
  styleUrls: ['./getting-started-coordinator.component.css']
})
export class GettingStartedCoordinatorComponent implements OnInit {

  title = 'getting-started-coordinator'
