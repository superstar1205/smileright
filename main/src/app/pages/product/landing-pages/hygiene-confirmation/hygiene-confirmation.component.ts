...
@Component({
  selector: 'app-hygiene-confirmation',
  templateUrl: './hygiene-confirmation.component.html',
  styleUrls: ['./hygiene-confirmation.component.css']
})
export class HygieneConfirmationComponent implements OnInit {
  @Input()
  patient;
  ...
  merchant_trading_name="Merchant"
