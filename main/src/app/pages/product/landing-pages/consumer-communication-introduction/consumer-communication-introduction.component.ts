...
@Component({
  selector: 'app-consumer-communication-introduction',
  templateUrl: './consumer-communication-introduction.component.html',
  styleUrls: ['./consumer-communication-introduction.component.css']
})
export class ConsumerCommunicationIntroductionComponent implements OnInit {
  title = 'Boutique'
