...
@Component({
  selector: 'app-consumer-smile-right',
  templateUrl: './consumer-smile-right.component.html',
  styleUrls: ['./consumer-smile-right.component.css']
})
export class ConsumerSmileRightComponent implements OnInit {
  title = 'Boutique'
