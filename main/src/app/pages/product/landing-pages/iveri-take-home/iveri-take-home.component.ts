...
@Component({
  selector: 'app-iveri-take-home',
  templateUrl: './iveri-take-home.component.html',
  styleUrls: ['./iveri-take-home.component.css'],
  animations: [
...
export class IveriTakeHomeComponent implements OnInit {
  title = 'Iveri Teeth Whitening'
  ...
  public ngOnInit() {
    ...
    this.metaTagService.updateTag(
      { name: 'description', content: 'A NEW ERA OF TEETH WHITENING IS HERE!' }
    );
    AOS.init();
    if (!this.merchant) {
