...
@Component({
  selector: 'app-hygiene-periodontist',
  templateUrl: './hygiene-periodontist.component.html',
  styleUrls: ['./hygiene-periodontist.component.css']
})
export class HygienePeriodontistComponent implements OnInit {
  @Input()
  patient;
