...
@Component({
  selector: 'app-sdi-take-home',
  templateUrl: './sdi-take-home.component.html',
  styleUrls: ['./sdi-take-home.component.css'],
  animations: [
...
export class SdiTakeHomeComponent implements OnInit {
  title = 'Pola Teeth Whitening'
  ...
  public ngOnInit() {
    ...
    this.metaTagService.updateTag(
      { name: 'description', content: 'Achieve a WHITER BRIGHTER SMILE with Pola Teeth Whitening' }
    );
