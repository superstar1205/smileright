...
@Component({
  selector: 'app-partner-pricing-general',
  templateUrl: './partner-pricing-general.component.html',
  styleUrls: ['./partner-pricing-general.component.css']
})
export class PartnerPricingGeneralComponent implements OnInit {
  title = 'general'
