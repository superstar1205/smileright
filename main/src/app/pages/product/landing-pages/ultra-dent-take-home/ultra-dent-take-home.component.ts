...
@Component({
  selector: 'app-ultra-dent-take-home',
  templateUrl: './ultra-dent-take-home.component.html',
  styleUrls: ['./ultra-dent-take-home.component.css'],
  animations: [
...
export class UltraDentTakeHomeComponent implements OnInit {
  title = 'ULTRADENT Take-Home - Professional Tooth Whitening'
