...
@Component({
  selector: 'app-dentist-general-info',
  templateUrl: './dentist-general-info.component.html',
  styleUrls: ['./dentist-general-info.component.css']
})
export class DentistGeneralInfoComponent implements OnInit {
  @Input()
  patient;
