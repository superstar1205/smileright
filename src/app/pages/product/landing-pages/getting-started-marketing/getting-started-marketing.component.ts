...
@Component({
  selector: 'app-getting-started-marketing',
  templateUrl: './getting-started-marketing.component.html',
  styleUrls: ['./getting-started-marketing.component.css']
})
export class GettingStartedMarketingComponent implements OnInit {
