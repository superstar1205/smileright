...
@Component({
  selector: 'app-partner-pricing-free',
  templateUrl: './partner-pricing-free.component.html',
  styleUrls: ['./partner-pricing-free.component.css']
})
export class PartnerPricingFreeComponent implements OnInit {
  title = 'Boutique'
  ...
  oncalmodal() {
    this.dialog.open(CalModalComponent);
  }
}
