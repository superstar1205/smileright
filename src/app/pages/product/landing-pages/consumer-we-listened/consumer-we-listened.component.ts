...
import AOS from 'aos';
@Component({
  selector: 'app-consumer-we-listened',
  templateUrl: './consumer-we-listened.component.html',
  styleUrls: ['./consumer-we-listened.component.css']
})
export class ConsumerWeListenedComponent implements OnInit {
  title = 'Boutique'
