...
@Component({
  selector: 'app-hygiene-recal2',
  templateUrl: './hygiene-recal2.component.html',
  styleUrls: ['./hygiene-recal2.component.css']
})
export class HygieneRecal2Component implements OnInit {
  @Input()
  patient;
