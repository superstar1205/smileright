...
@Component({
  selector: 'app-hygiene-recal1',
  templateUrl: './hygiene-recal1.component.html',
  styleUrls: ['./hygiene-recal1.component.css']
})
export class HygieneRecal1Component implements OnInit {
  @Input()
  patient;
