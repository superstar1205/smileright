...
@Component({
  selector: 'app-partner-let-get-started',
  templateUrl: './partner-let-get-started.component.html',
  styleUrls: ['./partner-let-get-started.component.css']
})
export class PartnerLetGetStartedComponent implements OnInit {
  title = 'Get-start'
