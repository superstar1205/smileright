...
@Component({
  selector: 'app-partner-pricing-calculator',
  templateUrl: './partner-pricing-calculator.component.html',
  styleUrls: ['./partner-pricing-calculator.component.css']
})
export class PartnerPricingCalculatorComponent implements OnInit {
  title = 'Boutique'
